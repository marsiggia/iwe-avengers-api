...
public class TokenGenerator {
	...
	public String getToken() {
		...
		final String clientId = "5ta8ch0ua5oi55tmpdnqrc723l";
		final String userPoolId = "us-east-2_JUK0HBHTN";
		...
		initiateAuthRequest.addAuthParametersEntry("USERNAME", "marcio.siggia");
